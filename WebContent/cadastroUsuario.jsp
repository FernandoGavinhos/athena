		...
		<div class="container">
			...
			<div class="coment-form">
				...
				<div id="divProfessor" style="display: none">
					...
					<form name="formProfessor" action="mvc?do=AdicionaProfessorController"
						method="post">
						...
						<p>Telefone:</p>
						<input type="text" id="telefone" name="telefone" required="false" />
						<p>Celular:</p>
						<input type="text" id="celular" name="celular" required="true" />
						<p>Link currículo Lattes:</p>
						<input type="text" id="curriculoLattes"  name="curriculoLattes" required="true" />
						<p>Senha:</p>
				...
				<div id="divAluno" style="display: none">
					...
					<form name="formProfessor" action="mvc?do=AdicionaAlunoController" method="post">
						...
						<p>Ano previsto para formação (dd/mm/yyyy):</p>
